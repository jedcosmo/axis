        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">              
              <div class="box-body pad">
                <?php echo form_open(current_url(), array('class' => '', 'id' => 'form-create_program')); ?>
                  ...
                  <div class="form-group" id="media_uploader">
                      ...
                      <p class="help-block">Size: 2MB • Dimension: 380 x 700</p>                            
                  ...
                  <div class="form-group">
                    ...
                    <?php echo anchor('admin/programs', lang('actions_cancel'), array('class' => 'btn btn-danger btn-flat')); ?>
                  </div>
