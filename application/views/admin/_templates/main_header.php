...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>AXIS</b> Admin</span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        ...
                                        <p><?php echo $user_login['firstname'].$user_login['lastname']; ?><small><?php echo lang('header_member_since'); ?> <?php echo date('F j, Y', strtotime($user_login['created_on'])); ?></small></p>
                                    </li>
