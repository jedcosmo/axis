<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        Client Form
        <small>Create - Post Initial Request for Increase in frequency</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Client Form</li>
        <li class="active">Create - Post Initial Request for Increase in frequency</li>
      </ol>
    </section>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <div class="checkbox">
                          <label>
                            <?php //echo form_checkbox($three_days_a_week); ?> 
                            3 Days a week
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                            <?php //echo form_checkbox($four_days_a_week); ?> 
                            4 Days a week
                          </label>
                        </div>
                        <div class="checkbox">
                          <label>
                            <?php //echo form_checkbox($five_days_a_week); ?> 
                            5 Days a week
                          </label>
                        </div>
                      </div>
