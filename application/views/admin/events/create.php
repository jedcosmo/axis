        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">              
              <div class="box-body pad">
                <?php echo form_open(current_url(), array('class' => '', 'id' => 'form-create_event')); ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php echo anchor('admin/events', lang('actions_cancel'), array('class' => 'btn btn-danger btn-flat')); ?>
                  </div>
