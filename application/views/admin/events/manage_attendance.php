                          ...
                          <td class="axis-actions">
                            ...
                            <?php
                              if(in_array($c->ID, $attendee_array)){
                                ...
                                $onclick = "addClientEventAttendance('".base_url()."','".$event_id."','".$c->ID."')";
                              }
                            ?>
                      ...
                      <tbody>
                        ...
                        <?php foreach($attendees as $a): ?>
                          <tr>
                            ...
                            <td><?php echo $a->number_of_guests ?></td>
                            <td><a href="javascript:void(0);" onclick="removeFromEvent('<?php echo base_url(); ?>','<?php echo $a->event_id; ?>','<?php echo $a->client_id ?>')" ><span class="label label-danger"><i title="Remove" class="fa fa-times"></i> Remove</span></a></td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
