...
/* Admin Restrictions per User Role */
$config['manager'] = array('reports','has_cms_menu','has_administration','has_clients_menu');
$config['instructor'] = array('demographics','assessment','authorizationrequest','reports');
$config['trainer'] = array('demographics','assessment','authorizationrequest','reports');
