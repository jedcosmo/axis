...
class Ion_auth_model extends CI_Model
{
	...
	**/
	...
	public function set_lang($lang = 'en')
	{
        ...
        /*
         * @developer: j.dymosco
         * This will get Array of user roles id and name
         */
        public function get_user_session_groups( $id = 0 ){
            $user_groups = array();
            $query = $this->get_users_groups($id);
	...
	public function set_session($user)
	{
		...
		$session_data = array(
		    ...
		    'old_last_login'       => $user->last_login,
                    'user_role' => $this->get_user_session_groups( $user->id )
		);
